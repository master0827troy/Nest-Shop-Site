  ...
  return (
    <div className='text-slate-900 bg-gray-300 bg-opacity-10 shadow-md'>
      <div className='section-container'>
        <div className='flex flex-row lg:justify-between items-center gap-5  sm:gap-15 md:gap-20 lg:gap-0 py-6'>
          <div className='flex flex-row items-center gap-2' onClick={() => setIsOpen(true)}>
            <FiMenu className={iconClasses} />
            <span className='hidden lg:block text-2xl capitalize tracking-wide cursor-pointer'>browse</span>
          </div>
          ...
          <SearchBar placeholder='Search' containerClass='hidden lg:block w-1/3' inputClass = '!py-2 rounded-sm' value={searchInputValue} onSearch={searchHandler} onIconClick={clickHandler} />
          <ul className='hidden lg:flex flex-col lg:flex-row items-center gap-3'>
