...
const ForgotPasswordForm = (props) => {
  ...
  return (
    <div className="flex items-center justify-center text-center">
      <div className='w-fit'>
        <h2 className="my-6 text-3xl font-extrabold text-gray-900">Forgot Password</h2>
        <form onSubmit={submitHandler}>
          <Input type='email' id='email-address' label='Email address' className='mb-8' value={email} setValue={setEmail} />
