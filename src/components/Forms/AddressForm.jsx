        ...
        <form>
          <div className="mb-8">
            <div className='mb-4 flex flex-row gap-6'>
              <Input label='Apartment' className='w-44' bgColor='!bg-gray-100' value={apartment} setValue={setApartment} />
              <Input label='Street' className='w-56' bgColor='!bg-gray-100' value={street} setValue={setAStreet} />
            </div>
            <div className='flex flex-row gap-5'>
              <Input label='City' className='w-32' bgColor='!bg-gray-100' value={city} setValue={setCity} />
              <Input label='Country' className='w-32' bgColor='!bg-gray-100' value={country} setValue={setCountry} />
              <Input label='ZIP Code' className='w-32' bgColor='!bg-gray-100' value={postalNumber} setValue={setPostalNumber} />
            </div>
          </div>
          <div className='flex flex-row gap-5'>
            <Button bg text='Cancel' className='h-fit' onClick={() => props.address ? props.changeHandler(null) : props.changeHandler(false)} />
            <Button bg text='Save' className='h-fit' onClick={props.address ? editAddressHandler : addAddressHandler} />
          </div>
        </form>
      }
    </>
